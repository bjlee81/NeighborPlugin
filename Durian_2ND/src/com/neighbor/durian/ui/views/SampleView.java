package com.neighbor.durian.ui.views;
...
public class SampleView extends ViewPart {
	 ...
	 */
	public static final String ID = Messages.SampleView_id;
	...
	public void createPartControl(Composite parent) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(viewer.getControl(), "com.neighbor.durian.viewer"); //$NON-NLS-1$
		makeActions();
		hookContextMenu();
